          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
            ...
            <div className="bg-[#151525] border-2 border-white/20 p-4 shadow-[4px_4px_0_0_#000]">
              <div className="flex items-center gap-2 font-pixel text-xs text-cyan-400 mb-2">
                ...
                <span>28 INSTANT MINI GAMES</span>
              </div>
              <p className="text-xs text-white/70">
                Pixel Aim, Clean Room, Catch It!, Light Up, Pixel Pop, Fast Food, Pixel Break, Pixel Snake, Pixel Stack, Math Dash, Pixel Racer, Color Switch, and 16 more!
              </p>
            </div>
